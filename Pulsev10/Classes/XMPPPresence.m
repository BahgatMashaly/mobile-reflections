...
- (NSString *)Latitude{
	return [[self elementForName:@"Latitude"] stringValue];
}
- (NSString *)Longitude{
	return [[self elementForName:@"Longitude"] stringValue];
}

-(NSString *)Activity{
	return [[self elementForName:@"Activity"] stringValue];
}

-(NSString *)Interest{
	return [[self elementForName:@"Interest"] stringValue];
}

-(NSString *) IsBlocked{
	return [[self elementForName:@"IsBlocked"] stringValue];
}
